...
const resourceHelpers = (context) => {
    return {
        ...
        getDescriptionForReflection: (model) => index_1.helpers.getDescriptionForReflection.apply(context, [model]),
        ...
        getGroupIndexTable: (children, kind) => index_1.helpers.getGroupIndexTable.apply(context, [children, kind]),
