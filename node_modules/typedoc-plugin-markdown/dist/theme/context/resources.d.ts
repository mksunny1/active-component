...
export declare const resourceHelpers: (context: MarkdownThemeContext) => {
    ...
    getDescriptionForReflection: (model: DeclarationReflection) => string | null;
    ...
    getGroupIndexTable: (children: DeclarationReflection[] | DocumentReflection[], kind?: ReflectionKind | undefined) => string;
