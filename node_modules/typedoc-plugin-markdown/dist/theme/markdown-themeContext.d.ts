...
export declare class MarkdownThemeContext {
    ...
    helpers: {
        ...
        getDescriptionForReflection: (model: import("typedoc").DeclarationReflection) => string | null;
        ...
        getGroupIndexTable: (children: import("typedoc").DeclarationReflection[] | import("typedoc").DocumentReflection[], kind?: import("typedoc").ReflectionKind | undefined) => string;
        ...
        getProjectName: (stringWithPlaceholders: string, page: MarkdownPageEvent<Reflection>) => string;
