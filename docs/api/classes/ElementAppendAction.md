...
[active-component](../globals.md) / ElementAppendAction

# Class: ElementAppendAction
...
### new ElementAppendAction()

> **new ElementAppendAction**(`element`, ...`reactions`): [`ElementAppendAction`](ElementAppendAction.md)
...
src/activity/element-actions.ts:112
